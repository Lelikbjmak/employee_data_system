...
@JsonPropertyOrder({EntityConstant.Column.ID_FIELD,
        ...
        DtoConstant.Json.IS_DELETED_FIELD_NAME})
@JsonRootName(value = DtoConstant.Employee.DELETED_EMPLOYEE_JSON_ROOT_NAME)
public record DeletedEmployeeDto(
        long id, String firstName, String middleName, String lastName, Date hireDate, boolean isDeleted) {
}
